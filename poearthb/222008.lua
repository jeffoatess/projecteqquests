...
function event_hp(e)
    if (e.hp_event == 70) then
        ...
        eq.modify_npc_stat("max_hit", "1794")
        eq.modify_npc_stat("accuracy", "300")
        eq.zone_emote(MT.Yellow, "The ground shudders beneath your feet as flecks of dirt and stone fall away from one of the Rathe.")
        eq.set_next_hp_event(40)
    elseif (e.hp_event == 40) then
        eq.modify_npc_stat("min_hit", "443")
        eq.modify_npc_stat("max_hit", "1524")
        eq.modify_npc_stat("accuracy", "200")
        eq.zone_emote(MT.Yellow, "The ground shudders beneath your feet as flecks of dirt and stone fall away from one of the Rathe.")
        eq.set_next_hp_event(20)
    elseif (e.hp_event == 20) then
        eq.modify_npc_stat("min_hit", "353")
        eq.modify_npc_stat("max_hit", "1254")
